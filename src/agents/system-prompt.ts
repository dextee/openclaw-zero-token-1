...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "## Tool Call Format",
    "",
    "To call a tool, output ONLY a ```tool_json code block with this exact format:",
    "```tool_json",
    "{\"tool\":\"read\",\"parameters\":{\"file_path\":\"/path/to/file.txt\"}}",
    "```",
    "",
    "Examples:",
    "```tool_json",
    ...
    "",
    "```tool_json",
    "{\"tool\":\"web_search\",\"parameters\":{\"query\":\"latest news\"}}",
    "```",
    "",
    "Multiple tools: output multiple ```tool_json blocks, one per tool.",
    "Never include any text before or after the ```tool_json block when calling tools.",
    "",
    ...safetySection,
